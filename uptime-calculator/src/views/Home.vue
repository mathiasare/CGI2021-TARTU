...
export default {
  ...
  methods: {
    ...
    findUptime() {
      ...
      const uptime =
        Math.floor((minutes_sunset - minutes_sunrise) / 60) +
        " hours and " +
        ((minutes_sunset - minutes_sunrise) % 60) +
        " minutes.";

      this.res = [
        "Sun rises at: " + sunrise.toTimeString(),
        "Sun sets at: " + sunset.toTimeString(),
        "Sun is up for: " + uptime,
      ];
    },
  },
};
